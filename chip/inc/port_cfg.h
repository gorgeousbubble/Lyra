...
#define UART1_TX_PIN    PTC4    //PTC4,PTE0                     //PTE0 should not be used (SDHC)
...
//UART3
#define UART3_RX_PIN    PTC16   //PTB10,PTC16,PTE5              //PTE5 should not be used (SDHC)
#define UART3_TX_PIN    PTC17   //PTB11,PTC17,PTE4              //PTE4 should not be used (SDHC)
...
*/
//FTM0
#define FTM0_CH0_PIN    PTC1    //PTC1,PTA3                     //PTA3 should not be used (JTAG)
...
#define FTM0_CH5_PIN    PTD5    //PTD5,PTA0                     //PTA0 should not be used (JTAG)
#define FTM0_CH6_PIN    PTD6    //PTD6,PTA1                     //PTA1 should not be used (JTAG)
#define FTM0_CH7_PIN    PTD7    //PTD7,PTA2                     //PTA2 should not be used (JTAG)
...
//I2C1
#define I2C1_SCL_PIN    PTC10   //PTE1,PTC10                    //PTE1 should not be used (SDHC)
#define I2C1_SDA_PIN    PTC11   //PTE0,PTC11                    //PTE0 should not be used (SDHC)
...
//I2C3
#define I2C3_SCL_PIN    PTE11    //PTA2,PTE11                   //PTA2 should not be used (JTAG)
#define I2C3_SDA_PIN    PTE10    //PTA1,PTE10                   //PTA1 should not be used (JTAG)
