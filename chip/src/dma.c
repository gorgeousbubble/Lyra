 ...
 *  @param      SADDR           source address( (void * )&PTx_Bn_IN �� (void * )&PTx_Wn_IN �� (void * )&PTx_IN  )
...
void DMA_PORTX_To_Buff_Init(DMA_CHn DMA_CHx, void *SADDR, void *DADDR, PTXn PTXx, DMA_BYTEn DMA_BYTEx, uint32 Count, DMA_CFG CFG)
{
  ...
  ASSERT(((DMA_BYTEx == DMA_BYTE1) && (SADDR >= &(((Dtype *)(&(PTA_BASE_PTR->PDIR)))->B[0]) && SADDR <= &(((Dtype *)(&(PTE_BASE_PTR->PDIR)))->B[3]))) || ((DMA_BYTEx == DMA_BYTE2) && (SADDR >= &(((Dtype *)(&(PTA_BASE_PTR->PDIR)))->B[0]) && SADDR <= &(((Dtype *)(&(PTE_BASE_PTR->PDIR)))->W[1])) && (((uint32)SADDR & 0x03) != 0x03)) || ((DMA_BYTEx == DMA_BYTE4) && (SADDR >= &(((Dtype *)(&(PTA_BASE_PTR->PDIR)))->B[0]) && SADDR <= &(((Dtype *)(&(PTE_BASE_PTR->PDIR)))->B[0])) && (((uint32)SADDR & 0x03) == 0x00)));
  ...
  DMAMUX_CHCFG_REG(DMAMUX_BASE_PTR, DMA_CHx) = (0 | DMAMUX_CHCFG_ENBL_MASK                        // DMA channel enable
...
void DMA_Count_Init(DMA_CHn DMA_CHx, PTXn PTXx, uint32 DMA_Count, PORT_CFG DMA_cfg)
{
  ...
  DMA_ATTR(DMA_CHx) = (0 | DMA_ATTR_SMOD(0)        // source address module address prohibition
