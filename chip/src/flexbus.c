...
void FlexBus_8080_Init(void)
{
  ...
  FB_CSMR(0) = (0 | FB_CSMR_BAM(FB_BAM) // BAM = 0x0800 , The base address mask is 0x, 800 FFFF, which means that the valid address for chip selection is the base address~(base address+base address mask). 0x0800 0000 corresponds to FBOAD27
