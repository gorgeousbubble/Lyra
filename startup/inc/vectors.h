...
#define VECTOR_046      default_isr     // 0x0000_00B8 46    30     --               void
...
#define VECTOR_071      default_isr     // 0x0000_011C 71    55     --               void
...
**variate declaration
*/
typedef void (*vector_entry)(void);             //interrupt vector tables function
