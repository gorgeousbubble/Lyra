...
void UART_Send_Parameters()
{
    ...
    /*Acc.X(1)*/
    temp = (signed int)FF.accAngleRoll; // MPU6050.Acc.X
    temp1 = (temp) >> 8;
    temp2 = (temp) & 0xFF;
    ...
    /*Acc.Y(2)*/
    temp = (signed int)FF.accAnglePitch; 
    temp1 = (temp) >> 8;
    temp2 = (temp) & 0xFF;
    UART_PutChar(UART_UART4, temp1);
    UART_PutChar(UART_UART4, temp2);
    ...
    /*Acc.Z(3)*/
    temp = (signed int)FF.accAngleYaw;        
    temp1 = (temp) >> 8;
    temp2 = (temp) & 0xFF;
    UART_PutChar(UART_UART4, temp1);
    UART_PutChar(UART_UART4, temp2);
    ...
    /*Gyro.X(4)*/
    temp = (signed int)FF.fusedAngleRoll; // MPU6050.Gyro.X
    temp1 = (temp) >> 8;
    temp2 = (temp) & 0xFF;
    UART_PutChar(UART_UART4, temp1);
    UART_PutChar(UART_UART4, temp2);
    ...
    /*Gyro.Y(5)*/
    temp = (signed int)FF.fusedAnglePitch;  // MPU6050.Gyro.Y
    temp1 = (temp) >> 8;
    temp2 = (temp) & 0xFF;
    UART_PutChar(UART_UART4, temp1);
    UART_PutChar(UART_UART4, temp2);
    ...
    /*Gyro.Z(6)*/
    temp = (signed int)FF.fusedAngleYaw;  // MPU6050.Gyro.Z
    temp1 = (temp) >> 8;
    temp2 = (temp) & 0xFF;
    UART_PutChar(UART_UART4, temp1);
    UART_PutChar(UART_UART4, temp2);
