...
void AllInit(void)
{
  ...
  */
  Fusion_Init(&FF_X, 0.85f, 0.01f); // Initialize Fusion Filter with alpha = 0.85 and dt = 0.01s
  Fusion_Init(&FF_Y, 0.85f, 0.01f); // Initialize Fusion Filter with alpha = 0.85 and dt = 0.01s
  Fusion_Init(&FF_Z, 0.85f, 0.01f); // Initialize Fusion Filter with alpha = 0.85 and dt = 0.01s
