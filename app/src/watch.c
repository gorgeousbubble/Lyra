...
void Render_Stop_Watch_Current_Time_Dial(const Coord *dial, const int dialLen, int minute, int second, int centisecond)
{
  ...
  for (int i = 0; i < 28; i+=2) 
  {
    ...
    uint8 centisecond_y = (uint8)(32 - (i + 1) * arm_cos_f32(centisecond_angle * (3.14159265358979323846 / 180.0)));
  ...
  uint8 bottomcentisecond_y = 32 - (int)(28 * arm_cos_f32(centisecond_angle * (3.14159265358979323846 / 180.0)));
