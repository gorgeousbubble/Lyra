...
extern const uint8 LCM_Pedometer_icon[];
extern const uint8 LCM_Attitude3D_icon[];
extern const uint8 LCM_TiltAlarm_icon[];
extern const uint8 LCM_GyroDash_icon[];
extern const uint8 LCM_FreeFall_icon[];
extern const uint8 LCM_HealthMonitor_icon[];
extern const uint8 LCM_ActivityHistory_icon[];
extern const uint8 LCM_SleepMonitor_icon[];
extern const uint8 LCM_AdcScope_icon[];
extern const uint8 LCM_HealthScore_icon[];
...
extern void Oled_I2C_Put_Time_Wo_Sec_6x8_12(uint8 x, uint8 y, uint8 ch[], int hour, int minute, int isAM);
extern void Oled_I2C_Put_Time_6x8_24(uint8 x, uint8 y, uint8 ch[], int hour, int minute, int second);
extern void Oled_I2C_Put_Time_Wo_Sec_6x8_24(uint8 x, uint8 y, uint8 ch[], int hour, int minute);
extern void Oled_I2C_Put_Time_8x16_12(uint8 x, uint8 y, uint8 ch[], int hour, int minute, int second, int isAM);
extern void Oled_I2C_Put_Time_Wo_Sec_8x16_12(uint8 x, uint8 y, uint8 ch[], int hour, int minute, int isAM);
extern void Oled_I2C_Put_Time_8x16_24(uint8 x, uint8 y, uint8 ch[], int hour, int minute, int second);
extern void Oled_I2C_Put_Time_Wo_Sec_8x16_24(uint8 x, uint8 y, uint8 ch[], int hour, int minute);
extern void Oled_I2C_Put_Time_12x24_12(uint8 x, uint8 y, uint8 ch[], int hour, int minute, int second, int isAM);
