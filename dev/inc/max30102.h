...
#define MAX30102_I2C_PORT_INIT_SCL       GPIO_Init(PTA12,GPO,0)
#endif
//I2C SDA port initialization
#ifndef MAX30102_I2C_PORT_INIT_SDA
#define MAX30102_I2C_PORT_INIT_SDA       GPIO_Init(PTA11,GPO,0)
#endif
//I2C SCL port output
#ifndef MAX30102_I2C_DDR_OUT_SCL
#define MAX30102_I2C_DDR_OUT_SCL         GPIO_DDRX(PTA12,1)
#endif
//I2C SDA port output
#ifndef MAX30102_I2C_DDR_OUT_SDA
#define MAX30102_I2C_DDR_OUT_SDA         GPIO_DDRX(PTA11,1)
#endif
//I2C SDA port input
#ifndef MAX30102_I2C_DDR_IN_SDA
#define MAX30102_I2C_DDR_IN_SDA          GPIO_DDRX(PTA11,0)
#endif
//I2C SCL port high level
#ifndef MAX30102_I2C_SET_SCL_H
#define MAX30102_I2C_SET_SCL_H           GPIO_SET(PTA12,1)
#endif
//I2C SCL port low level
#ifndef MAX30102_I2C_SET_SCL_L
#define MAX30102_I2C_SET_SCL_L           GPIO_SET(PTA12,0)
#endif
//I2C SDA port high level
#ifndef MAX30102_I2C_SET_SDA_H
#define MAX30102_I2C_SET_SDA_H           GPIO_SET(PTA11,1)
#endif
//I2C SDA port low level
#ifndef MAX30102_I2C_SET_SDA_L
#define MAX30102_I2C_SET_SDA_L           GPIO_SET(PTA11,0)
#endif
//I2C SDA port input signal
#ifndef MAX30102_I2C_GET_SDA_IN
#define MAX30102_I2C_GET_SDA_IN          GPIO_GET(PTA11)
#endif
