 ...
 *
 * @file       max30102.h
 * @brief      MAX30102 heart rate / SpO2 sensor driver (GPIO bit-bang I2C, PTE10/PTE11)
 * @author     alopex
 * @version    v1.0
 * @date       2025-06-24
 */
...
// I2C device address (fixed, 0x57 << 1 = 0xAE)
...
// GPIO bit-bang I2C pins: SCL=PTE10, SDA=PTE11
...
extern uint8 MAX30102_I2C_GPIO_Write_Reg(uint8 I2C_Div_Adr, uint8 I2C_Reg_Adr, uint8 I2C_Data);
